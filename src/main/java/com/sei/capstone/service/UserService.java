...
import com.sei.capstone.exceptions.InformationExistsException;
...
public class UserService {
    ...
    public User registerUser(User userObject){
        ...
        }else throw new InformationExistsException("User with email address " + userObject.getEmail() + " already exists");
    }
